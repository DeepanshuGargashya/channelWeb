...
function AdminLogin() {
  ...
  const handleVerifyOtp = async () => {
    if (otp.length === 4) {
      ...
      await axios
        .post(`${API_URL}/auth/admin/verifyotp`, payload)
        .then((res) => {
  ...
  const handleSubmit = async () => {
    ...
    if (
      ...
      await axios
        .post(`${API_URL}/auth/admin/sendotp`, payload)
        .then((res) => {
          console.log(res);
          if (res.data.status === 200) {
      ...
      <div className="container">
        <div style={{ marginBottom: "1rem", marginTop: "1rem" }}>
          <img
            ...
            src={require("../../assets/images/serverLogin.png")}
          />
        </div>
        <div style={{ marginBottom: "1rem", marginTop: "1rem", width: "60%" }}>
          <div
            style={{
              width: "100%",
              margin: "auto",
